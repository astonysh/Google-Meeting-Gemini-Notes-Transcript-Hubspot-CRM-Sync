...
Automatically syncs Google Meet meeting notes and transcripts generated by Gemini into your HubSpot CRM meeting records.
...
This tool finds those documents, matches them to the corresponding HubSpot meeting record by start time, and writes the formatted notes directly into the HubSpot meeting body. A link to the full transcript is included.
